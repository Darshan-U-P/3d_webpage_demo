...
export default function FeatureFlip() {
  ...
  return (
    <section className="flip-demo feature-section px-4 md:px-12 py-8 md:py-10">
      <div className="max-w-[1200px] mx-auto rounded-[30px] border border-white/10 bg-slate-950/80 p-6 md:p-8 shadow-[0_40px_80px_rgba(0,0,0,0.4)] backdrop-blur-lg">
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-full sm:max-w-xl text-gray-300 leading-relaxed">
              Tap the card to move it between two frames and feel the layout transform with a clean Flip transition.
            </p>
            <button
              type="button"
              className="px-6 py-3 rounded-full bg-cyan-500 text-black font-semibold uppercase tracking-wider shadow-lg shadow-cyan-500/30 hover:bg-cyan-400 transition"
              onClick={toggleFlip}
            >
          ...
          <div className="flip-panel relative rounded-[26px] border border-white/10 bg-zinc-950/70 p-4 md:p-6 min-h-[260px] md:min-h-[340px] overflow-hidden">
